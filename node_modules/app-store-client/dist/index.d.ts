...
interface AppOptions extends AppStoreClientOptions {
    id?: string;
    appId?: string;
    ratings?: boolean;
}
...
interface ListOptions extends AppStoreClientOptions {
...
interface SearchOptions extends AppStoreClientOptions {
    term: string;
    num?: number;
    page?: number;
    idsOnly?: boolean;
...
interface DeveloperOptions extends AppStoreClientOptions {
    devId: string;
}

interface PrivacyOptions extends AppStoreClientOptions {
    id: string;
}

interface SuggestOptions extends AppStoreClientOptions {
    term: string;
}

interface SimilarOptions extends AppStoreClientOptions {
    id?: string;
    appId?: string;
}

interface ReviewOptions extends AppStoreClientOptions {
    id?: string;
    appId?: string;
    sort?: string;
    page?: number;
...
interface RatingsOptions extends AppStoreClientOptions {
    id: string;
}

interface AppStoreClientOptions {
    country?: Country;
    language?: string;
    requestOptions?: any;
    throttle?: number;
...
declare class AppStoreClient {
    ...
    app: (options: AppOptions) => Promise<App>;
    list: (options: ListOptions) => Promise<App[]>;
    search: (options: SearchOptions) => Promise<App[] | string[]>;
    appsByDeveloper: (options: DeveloperOptions) => Promise<App[]>;
    privacy: (options: PrivacyOptions) => Promise<PrivacyDetails>;
    suggestedTerms: (options: SuggestOptions) => Promise<Suggestion[]>;
    similarApps: (options: SimilarOptions) => Promise<App[]>;
    reviews: (options: ReviewOptions) => Promise<Review[]>;
    ratings: (options: RatingsOptions) => Promise<RatingsResult>;
}

export { type App, AppStoreClient, type AppStoreClientOptions, Category, Collection, Country, Device, type RatingsResult, type Review, Sort, type Suggestion };
